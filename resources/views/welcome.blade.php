            ...
            <div class="flex flex-col items-center justify-center mb-12">
                ...
                @guest
                    <div class="flex flex-col sm:flex-row gap-4 mb-8">
                        <a href="{{ url('/login') }}" class="inline-flex items-center justify-center px-10 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105">
